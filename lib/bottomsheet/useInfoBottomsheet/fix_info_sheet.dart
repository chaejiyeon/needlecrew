    ...
    return FutureBuilder(
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.done) {
            ...
            int cost = int.parse(controller.order.lineItems!.first.price
                .toString());
            int shipCost = 6000;
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          fixInfoTitle == "detailInfo" || readyInfo != 6 ? priceInfo("총 의뢰 예상 비용", wholePrice) : priceInfo("최종 결제 비용", wholePrice) ,
                          fixInfoTitle == "detailInfo"
                            ...
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                  ...
                                  GestureDetector(
                                    onTap: () {
                                      readyInfo >= 3 ? Get.dialog(AlertDialogYesNo(titleText: "수선을 취소하시겠습니까?", contentText: "수선 취소시 등록된 카드 정보로 왕복 배송비 6,000원이 결제됩니다.", icon: "", iconPath: "", btntext1: "이전", btntext2: "확인")) :
                                      Get.dialog(TearIconModal(title: "접수한 의뢰를 취소할까요?", btnText1: "아니요", btnText2: "예, 취소할게요."));
                                    },
                                    child: Container(
              ...
              GestureDetector(
                child: Row(
                  children: [
                    ...
                    costtitle == "총 의뢰 예상 비용" || costtitle == "최종 결제 비용" ? Container(width: 0,) : Icon(
              ...
              Row(
                children: [
                  FontStyle(
                      ...
                      fontbold: "bold",
                      fontcolor: costtitle == "총 의뢰 예상 비용" || costtitle == "최종 결제 비용" ? HexColor("#fa9d03") : Colors.black,
                      textdirectionright: false),
                  FontStyle(
                      text: "원",
                      fontsize: "",
