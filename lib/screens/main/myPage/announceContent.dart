...
class AnnounceContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: MypageAppBar(appbar: AppBar(),title: "공지 사항", widget: MainHome(),icon: ""),
      body: Container(
        padding: EdgeInsets.only(left: 24, right: 24,top: 30),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text("12월 15일, 니들크루 수선 요금이 변경됩니다!", style: TextStyle(fontWeight: FontWeight.bold),),
            Text("2021-12-01", style: TextStyle(color: HexColor("#707070")),),
            SizedBox(height: 11,),
            ListLine(height: 1, width: double.infinity, lineColor: HexColor("#ededed"), opacity: 1),
