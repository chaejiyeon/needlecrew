                  ...
                  function: () {
                    ...
                    if (authOk) {
                      homeController.setUserInfo(
                          "phoneNum", editingcontroller[0].text);
            ...
            GestureDetector(
              onTap: () async {
                if (btnText == "인증요청" || btnText == "재요청") {
                  ...
                  loginController.sendSMS(editingcontroller[0].text);
                }
                if (btnText == "확인") {
                  if (loginController.verificationCode.value ==
                    ...
                    Get.snackbar('인증번호', '인증번호를 확인해주세요!');
                  }
                }
              },
              child: Container(
